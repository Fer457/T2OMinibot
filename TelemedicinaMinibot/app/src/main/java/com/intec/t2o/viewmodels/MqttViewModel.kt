...
class MqttViewModel @Inject constructor(
    ...
    enum class NavigationState {
        EyesScreen, HomeScreen, NumericPanelScreen, MeetingScreen, UnknownVisitsScreen, PackageAndMailManagementScreen, DrivingScreen, MqttScreen, AdminPanelScreen, ClockInScreen, InfoScreen
    }
    ...
    fun navigateToInfoScreen() {
        detectionJob?.cancel()
        _navigationState.value = NavigationState.InfoScreen
    }
